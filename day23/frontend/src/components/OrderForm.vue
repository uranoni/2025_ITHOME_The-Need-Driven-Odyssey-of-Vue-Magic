...
<template>
  <!-- Day 3：姓名/備註 -->
  <div :class="['form-block', 'name-block', name ? 'complete' : 'invalid']">
    <label class="form-label">{{ t('fields.name') }}（{{ t('common.required') }}）
      <input 
        type="text" 
        class="form-input"
        v-model.trim="name" 
  ...
  <div class="form-block note-block">
    <label class="form-label">{{ t('fields.note') }}（{{ t('common.optional') }}）
      <textarea 
        class="form-textarea"
        v-model.trim="note" 
...
.form-block.name-block.complete {
  border-color: #66bb6a !important;
  background: #f3fff3 !important;
}

.form-block.name-block.invalid {
  border-color: #e57373 !important;
  background: #fff5f5 !important;
}

/* 暗色模式下的驗證狀態 */
[data-theme="dark"] .form-block.name-block.complete {
  border-color: #66bb6a !important;
  background: #1b2d1b !important;
}

[data-theme="dark"] .form-block.name-block.invalid {
  border-color: #e57373 !important;
  background: #2d1b1b !important;
}

.form-block.note-block {
