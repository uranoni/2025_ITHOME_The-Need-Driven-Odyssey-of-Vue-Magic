...
import MenuWizardPage from '../pages/MenuWizardPage.vue'
import AdminOCRPage from '../pages/AdminOCRPage.vue'
...
const routes = [
  ...
  { path: '/login', component: LoginPage },
  {
    ...
    children: [
      ...
      { path: 'menu', component: MenuWizardPage },
      { path: 'admin/ocr', component: AdminOCRPage, meta: { requiresAdmin: true } }
    ]
  }
]
